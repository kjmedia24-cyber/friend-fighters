...
const FX = (() => {
  ...
  const MUSIC = {
    ...
    parking: { // 지하 주차장: 어둡고 긴장감 있는 저음 그루브
      bpm: 92, wave: 'sawtooth',
      bass: [33, 0, 33, 36, 0, 33, 0, 31, 33, 0, 33, 36, 0, 38, 36, 0],
      lead: [57, 0, 0, 60, 0, 57, 63, 0, 0, 57, 0, 60, 64, 63, 0, 60,
             57, 0, 0, 60, 0, 57, 63, 0, 65, 64, 0, 63, 60, 0, 57, 0]
    }
  };
